// Command migrate-gen generates SQL migration files for the orchestrator.
//
// Usage:
//
//	go run github.com/getpup/pupsourcing-orchestrator/cmd/migrate-gen -output migrations -filename orchestrator_init.sql
//
// Or with go generate:
//
...
//
//	go run github.com/getpup/pupsourcing-orchestrator/cmd/migrate-gen -generations-table my_generations -workers-table my_workers
//
// The down migration is optional and not generated by default. Use -generate-down to include it:
//
//	go run github.com/getpup/pupsourcing-orchestrator/cmd/migrate-gen -generate-down
package main
